...
################################################################################
# ONLY USE THIS SECTION IF YOU PLAN TO USE SCRIPT 8-calc_map_exsitu_coverage.R
#
# **Manually** download ecoregions shapefile(s)
################################################################################

# Depending on the scale/region of your analysis, choose one of the following 
#   ecoregions to use in analyses and mapping...
